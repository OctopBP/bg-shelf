...
-- в окне добавления игр). Сортировка — по рейтингу BGG (games.rating) по
-- убыванию, чтобы сверху были популярные игры. Возвращает total_count окном,
-- чтобы UI построил пагинацию без отдельного count-запроса.
-- ===========================================================================
